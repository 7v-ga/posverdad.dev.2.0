...
def test_spacy_model_string_invalid_fallback_blank(monkeypatch):
    ...
    o = NLPOrchestrator(spacy_model="modelo_inexistente", postverdad_nlp=None, framing_analyzer=None, preprocessor=None)
    out = o.analyze("hola")
...
def test_non_callable_nlp_object_skips_ner():
    o = NLPOrchestrator(spacy_model=object(), postverdad_nlp=None, framing_analyzer=None, preprocessor=None)
    out = o.analyze("texto")
